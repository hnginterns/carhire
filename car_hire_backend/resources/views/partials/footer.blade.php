		  ...
		  <div class="container"  style='padding:10px; border-top:none'>
		    <div class="row">
		      <div class="col-sm-3 footer1" >
		      	<img class="center image1" src="http://res.cloudinary.com/siazo/image/upload/v1507562729/car_jyrdnk.png" height="50" width="140">
		      	<ul>
		      		<li>About</li>
		      		<li>Locations</li>
		      		<li>Contact Us</li>
		      ...
		      <div class="col-sm-3 footer2" id="footer" >
		          <span><b>Product & Services</b></span>
		          <ul>
		          	<li>Vehicles</li>
		          	<li>Drivers</li>
		          	<li>Hire Advice</li>
		      ...
		      <div class="col-sm-3 footer4" id="footer">
		        <span>
		        	...
		        	<br><br>
		        	<img src="http://res.cloudinary.com/siazo/image/upload/v1507639912/twitter-256_z1pfxb.png" height="45" width="45" >
